AFRAME.registerComponent("create-markers", {
  init: async function () {
    ...
    toys.map(toy => {
      ...
      if (!toy.unavailable_toys.includes(toys[todaysDay])) {
        ...
        ratinglane.setAttribute("position", { x: 2, y: 0, z: 0.5 });
        ...
        rating.setAttribute("position", { x: 0.03, y: 0.05, z: 0.1 });
        ...
        review.setAttribute("position", { x: 0.03, y: 0.05, z: 0.1 });
